            ...
            <div class="container">
                <div class="card">
                    <div class="card-header">
                      <h4 class="card-title">Form Tambah Masjid</h4>
                    </div>
                    <div class="card-content">
                      <div class="card-body">
                        <div class="table-responsive">
                            <table class="table align-items-center mb-0">
                                <form class="form-group" action="/masjid/store" method="POST">

                                    @csrf
                                    <div class="m-3">
                                        <label for="exampleFormControlInput1" class="form-label">Nama masjid</label>
                                        <input type="text" class="form-control" name="nama_masjid"  id="exampleFormControlInput1"
                                            required>
                                    </div>
                                    ...
                                    <div class="m-3">
                                        ...
                                        <textarea class="form-control" name="alamat_masjid"   id="exampleFormControlTextarea1" rows="3" required></textarea>
                                    </div>
                                    <div class="m-3">
