...
<div class="page-heading">
                ...
                <table class="table" id="table1">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Total Uang (Rp)</th>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <a href="/stock/create"><button class="btn btn-primary ">Tambah data</button></a>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                <table class="table" id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class=" text-center">
                                    <form action="/stock-delete/{{ $stock->id}}" class="mb-0" method="POST">
                                        @csrf
                                        @method('delete')
