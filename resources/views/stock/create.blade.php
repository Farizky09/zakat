                      ...
                      <div class="card-body">
                        <div class="table-responsive">
                            <table class="table align-items-center mb-0">
                                <form class="form-group" action="/stock/store" method="POST">

                                    @csrf
                                    <div class="m-3">
                                        <label for="exampleFormControlInput1" class="form-label">Total beras</label>
                                        <input type="text" class="form-control" name="beras"  id="exampleFormControlInput1"
                                            required>
                                    </div>
                                    <div class="m-3">
                                        <label for="exampleFormControlInput1" class="form-label">Total uang</label>
                                        <input type="text" class="form-control" name="uang"  id="exampleFormControlInput1"
                                            required>
                                    </div>
