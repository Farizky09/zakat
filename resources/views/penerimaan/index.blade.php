    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <a href="/penerimaan/create"><button class="btn btn-primary ">Tambah data</button></a>
            </div>
            <div class="card-body">
                    ...
                    <thead>
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>{{ $penerimaan->nama_penerima}}</td>
                              <td>{{ $penerimaan->pembayaran_uang }}</td>
                              <td>{{ $penerimaan->pembayaran_beras }}</td>

                              <td class=" text-center">
                                  <form action="/penerimaan-delete/{{ $penerimaan->id_penerimaan }}" class="mb-0" method="POST">
                                      @csrf
                                      @method('delete')
                                      <input class="btn btn-outline-danger btn-sm mx-1 mb-0 " type="submit"
                                          onclick="return confirm('apakah anda yakin ingin dihapus?')"
                                          value="Delete">
                                      <a href="/penerimaan/{{ $penerimaan->id_penerimaan }}/edit"
